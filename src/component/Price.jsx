      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-16 grid gap-8 lg:grid-cols-4 lg:gap-6">
          ...
          <div className="relative flex flex-col rounded-2xl border border-gray-200 bg-white p-8 shadow-sm transition-all hover:shadow-lg">
            <div className="mb-6">
              <h3 className="text-lg font-semibold leading-5 text-gray-900">ブロンズプラン</h3>
              <p className="mt-8">
                <span className="text-4xl font-bold tracking-tight text-gray-900">¥1,650</span>
            ...
            <ul className="mb-8 space-y-4 flex-1">
              ...
              <li className="flex items-center">
                <Check className="h-5 w-5 text-green-500" />
              <span className="ml-3 text-gray-700">撥水洗車</span>
              </li>
              <li className="flex items-center">
              ...
              <li className="flex items-center">
                <X className="h-5 w-5 text-red-500" />
                <span className="ml-3 text-gray-700">もこもこ泡洗車</span>
              </li>
              <li className="flex items-center">
                <X className="h-5 w-5 text-red-500" />
